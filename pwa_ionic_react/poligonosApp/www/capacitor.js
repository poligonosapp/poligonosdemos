...
var capacitorExports = (function (e) {
    ...
    ;((t = e.CameraSource || (e.CameraSource = {})).Prompt = 'PROMPT'),
        ...
        ((o = e.FilesystemEncoding || (e.FilesystemEncoding = {})).UTF8 =
            'utf8'),
        (o.ASCII = 'ascii'),
        (o.UTF16 = 'utf16'),
        ((s = e.HapticsImpactStyle || (e.HapticsImpactStyle = {})).Heavy =
            'HEAVY'),
        (s.Medium = 'MEDIUM'),
        (s.Light = 'LIGHT'),
        ((a =
            e.HapticsNotificationType ||
            (e.HapticsNotificationType = {})).SUCCESS = 'SUCCESS'),
        (a.WARNING = 'WARNING'),
        (a.ERROR = 'ERROR'),
        ...
        ((l =
            ...
            (e.ActionSheetOptionStyle = {})).Default = 'DEFAULT'),
        ...
        (h.Light = 'LIGHT'),
        ((f = e.StatusBarAnimation || (e.StatusBarAnimation = {})).None =
            'NONE'),
        (f.Slide = 'SLIDE'),
        (f.Fade = 'FADE')
    var m,
            ...
            return (
                (e.prototype.pluginMethodNoop = function (e, t, r) {
                    return Promise.reject(
                        r + ' does not have web implementation.'
                    )
                }),
    ...
    var A = (function (e) {
        ...
        D = (function (e) {
            function t() {
                var t =
                    e.call(this, { name: 'App', platforms: ['web'] }) || this
                return (
        ...
        I = (function (e) {
            function t() {
                return (
                    e.call(this, { name: 'Browser', platforms: ['web'] }) ||
                    this
                )
            }
            return (
        ...
        O = (function (t) {
            function r() {
                return (
                    t.call(this, { name: 'Camera', platforms: ['web'] }) || this
                )
            }
            return (
                R(r, t),
                        ...
                        n.addEventListener('change', function (o) {
                            ...
                            if (
                                ...
                                u.addEventListener('load', function () {
                                    if (
                                        t.resultType ===
                                        e.CameraResultType.DataUrl
                                    )
                                        r({ dataUrl: u.result, format: a })
                                    else if (
                                        t.resultType ===
                                        e.CameraResultType.Base64
                                    ) {
        ...
        W = (function (e) {
            function t() {
                return (
                    e.call(this, { name: 'Clipboard', platforms: ['web'] }) ||
                    this
                )
            }
            return (
        ...
        k = (function (t) {
            function r() {
                var r =
                    t.call(this, { name: 'Filesystem', platforms: ['web'] }) ||
                    this
                return (
                        ...
                        return T(this, function (d) {
                            switch (d.label) {
                                ...
                                case 1:
                                    ...
                                    return [
                                        4,
                                        this.readdir({ path: t, directory: r }),
                                    ]
                                case 2:
                            ...
                            return T(this, function (w) {
                                switch (w.label) {
                                    case 0:
                                        ...
                                        if (a.startsWith(s))
                                            throw Error(
                                                'To path cannot contain the from path'
                                            )
                                        w.label = 1
                                    case 1:
                                        return (
        ...
        G = (function (e) {
            ...
            return (
                ...
                (t.prototype.createChannel = function (e) {
                    throw new Error(
                        'Feature not available in the browser. ' + e.id
                    )
                }),
            ...
            return (
                ...
                (t.prototype.alert = function (e) {
                    return C(this, void 0, void 0, function () {
                        return T(this, function (t) {
                            return (
                                window.alert(e.message), [2, Promise.resolve()]
                            )
                        })
                    })
                }),
        ...
        Z = (function (e) {
            function t() {
                var t =
                    e.call(this, { name: 'Network', platforms: ['web'] }) ||
                    this
                            ...
                            switch (i.label) {
                                case 0:
                                    return (r = window.navigator).permissions
                                        ? ((n =
                                              t.name === e.PermissionType.Photos
                                                  ? 'camera'
                                                  : t.name),
        ...
        oe = (function (e) {
            function t() {
                var t =
                    e.call(this, { name: 'Storage', platforms: ['web'] }) ||
                    this
            ...
            return (
                ...
                (t.prototype.set = function (e) {
                    var t = this
                    return new Promise(function (r, n) {
                        window.localStorage.setItem(t.makeKey(e.key), e.value),
                            r()
                    })
                }),
