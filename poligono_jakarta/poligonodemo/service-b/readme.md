...
This will create an executable jar file **poligonodemo-microbundle.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/poligonodemo-microbundle.jar --port 8180
